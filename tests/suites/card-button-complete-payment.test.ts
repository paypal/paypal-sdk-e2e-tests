...
describe("card button 3ds flow", () => {
    it("should show the inline guest form when clicking on the card button", async () => {
        ...
        await browser.buttonsUrl(
            `http://localhost:8081/docs/components/card-buttons/card-buttons.html?sdkBaseURL=https://<stageURL>/sdk/js&client-id=AfALq_mQ3SUUltuavn8MnEaXPCPFRl4aOZDTcDTo1I4FsJGN3TPFZ1THvcT39wAF3S250a5oqCUbpJHH&currency=GBP&allowBillingPayments=false`
        );
